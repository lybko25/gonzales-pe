...
/***/ (function(module, exports) {
	...
	module.exports = function stringify(tree) {
	  ...
	  var _unique = {
	    ...
	    interpolationJs: function interpolationJs(t) {
	      return "${" + _composite(t.content) + "}";
	    },
	    multilineComment: function multilineComment(t) {
	      return "/*" + t.content + "*/";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ParsingError = __webpack_require__(9);
	var syntaxes = __webpack_require__(11);
	...
	function parser(css, options) {
	  if (typeof css !== 'string') throw new Error('Please, pass a string to parse');else if (!css) return __webpack_require__(34)();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var parserPackage = __webpack_require__(10);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  less: __webpack_require__(18),
	  sass: __webpack_require__(22),
	  scss: __webpack_require__(26),
	  jss: __webpack_require__(30)
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var TokenType = __webpack_require__(14);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Node = __webpack_require__(1);
	var NodeType = __webpack_require__(16);
	var TokenType = __webpack_require__(14);
...
/***/ (function(module, exports) {
	...
	module.exports = {
	  ...
	  InterpolationJsType: "interpolationJs",
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.__esModule = true;
	exports.default = {
	  mark: __webpack_require__(23),
	  parse: __webpack_require__(24),
	  stringify: __webpack_require__(6),
	  tokenizer: __webpack_require__(25)
	};
	module.exports = exports['default'];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.__esModule = true;
	exports.default = {
	  mark: __webpack_require__(27),
	  parse: __webpack_require__(28),
	  stringify: __webpack_require__(7),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var contexts = {
	  ...
	  interpolationJs: function interpolationJs() {
	    return checkInterpolationJs(pos) && getInterpolationJs();
	  },
	  loop: function loop() {
	    return checkLoop(pos) && getLoop();
	  },
	...
	function checkAny(i) {
	  ...
	  if (l = checkInterpolationJs(i)) tokens[i].any_child = 0;else if (l = checkBrackets(i)) tokens[i].any_child = 1;else if (l = checkParentheses(i)) tokens[i].any_child = 2;else if (l = checkString(i)) tokens[i].any_child = 3;else if (l = checkVariablesList(i)) tokens[i].any_child = 4;else if (l = checkVariable(i)) tokens[i].any_child = 5;else if (l = checkPlaceholder(i)) tokens[i].any_child = 6;else if (l = checkPercentage(i)) tokens[i].any_child = 7;else if (l = checkDimension(i)) tokens[i].any_child = 8;else if (l = checkUnicodeRange(i)) tokens[i].any_child = 9;else if (l = checkNumber(i)) tokens[i].any_child = 10;else if (l = checkUri(i)) tokens[i].any_child = 11;else if (l = checkExpression(i)) tokens[i].any_child = 12;else if (l = checkFunctionsList(i)) tokens[i].any_child = 13;else if (l = checkFunction(i)) tokens[i].any_child = 14;else if (l = checkInterpolation(i)) tokens[i].any_child = 15;else if (l = checkIdent(i)) tokens[i].any_child = 16;else if (l = checkClass(i)) tokens[i].any_child = 17;else if (l = checkUnary(i)) tokens[i].any_child = 18;else if (l = checkParentSelector(i)) tokens[i].any_child = 19;else if (l = checkImportant(i)) tokens[i].any_child = 20;else if (l = checkGlobal(i)) tokens[i].any_child = 21;else if (l = checkDefault(i)) tokens[i].any_child = 22;else if (l = checkOptional(i)) tokens[i].any_child = 23;
	...
	function checkArgument(i) {
	  ...
	  if (l = checkInterpolationJs(i)) tokens[i].argument_child = 27;else if (l = checkBrackets(i)) tokens[i].argument_child = 1;else if (l = checkParentheses(i)) tokens[i].argument_child = 2;else if (l = checkSingleValueDeclaration(i)) tokens[i].argument_child = 3;else if (l = checkFunctionsList(i)) tokens[i].argument_child = 4;else if (l = checkFunction(i)) tokens[i].argument_child = 5;else if (l = checkVariablesList(i)) tokens[i].argument_child = 6;else if (l = checkVariable(i)) tokens[i].argument_child = 7;else if (l = checkSC(i)) tokens[i].argument_child = 8;else if (l = checkDelim(i)) tokens[i].argument_child = 9;else if (l = checkDeclDelim(i)) tokens[i].argument_child = 10;else if (l = checkString(i)) tokens[i].argument_child = 11;else if (l = checkPercentage(i)) tokens[i].argument_child = 12;else if (l = checkDimension(i)) tokens[i].argument_child = 13;else if (l = checkNumber(i)) tokens[i].argument_child = 14;else if (l = checkUri(i)) tokens[i].argument_child = 15;else if (l = checkInterpolation(i)) tokens[i].argument_child = 16;else if (l = checkIdent(i)) tokens[i].argument_child = 17;else if (l = checkVhash(i)) tokens[i].argument_child = 18;else if (l = checkCustomProperty(i)) tokens[i].argument_child = 19;else if (l = checkOperator(i)) tokens[i].argument_child = 20;else if (l = checkUnary(i)) tokens[i].argument_child = 21;else if (l = checkParentSelector(i)) tokens[i].argument_child = 22;else if (l = checkImportant(i)) tokens[i].argument_child = 23;else if (l = checkGlobal(i)) tokens[i].argument_child = 24;else if (l = checkDefault(i)) tokens[i].argument_child = 25;else if (l = checkOptional(i)) tokens[i].argument_child = 26;
	...
	function _checkCondition(i) {
	  return checkVariable(i) || checkNumber(i) || checkInterpolation(i) || checkInterpolationJs(i) || checkIdent(i) || checkOperator(i) || checkCombinator(i) || checkString(i);
	}
	 ...
	 * @returns {Number}
	 */
	function checkInterpolationJs(i) {
	  var start = i;
	  var l = void 0;

	  if (i >= tokensLength) return 0;

	  if (tokens[i].type !== TokenType.DollarSign || !tokens[i + 1] || tokens[i + 1].type !== TokenType.LeftCurlyBracket) return 0;
	 ...
	 * @returns {Array} `['interpolation', x]`
	 */
	function getInterpolationJs() {
	  var type = NodeType.InterpolationJsType;
	  var token = tokens[pos];
	  var line = token.ln;
	  var column = token.col;
	  var content = [];
	...
	function checkLoop(i) {
	  ...
	  while (i < tokensLength) {
	    if (l = checkBlock(i)) {
	      i += l;
	      break;
	    } else if (l = checkVariable(i) || checkNumber(i) || checkInterpolation(i) || checkInterpolationJs(i) || checkIdent(i) || checkSC(i) || checkOperator(i) || checkCombinator(i) || checkString(i)) i += l;else return 0;
	  }
	...
	function checkNumberOrInterpolation(i) {
	  ...
	  while (i < tokensLength) {
	    if (l = checkInterpolation(i) || checkInterpolationJs(i) || checkNumber(i)) i += l;else break;
	  }
	...
	function getNumberOrInterpolation() {
	  ...
	  while (pos < tokensLength) {
	    if (checkInterpolation(pos)) content.push(getInterpolation());else if (checkInterpolationJs(pos)) content.push(getInterpolationJs());else if (checkNumber(pos)) content.push(getNumber());else break;
	  }
	...
	function checkStylesheet(i) {
	  ...
	  while (i < tokensLength) {
	    if (l = checkSC(i)) tokens[i].stylesheet_child = 1;else if (l = checkRuleset(i)) tokens[i].stylesheet_child = 2;else if (l = checkInclude(i)) tokens[i].stylesheet_child = 3;else if (l = checkExtend(i)) tokens[i].stylesheet_child = 4;else if (l = checkMixin(i)) tokens[i].stylesheet_child = 5;else if (l = checkLoop(i)) tokens[i].stylesheet_child = 6;else if (l = checkConditionalStatement(i)) tokens[i].stylesheet_child = 7;else if (l = checkAtrule(i)) tokens[i].stylesheet_child = 8;else if (l = checkDeclaration(i)) tokens[i].stylesheet_child = 9;else if (l = checkDeclDelim(i)) tokens[i].stylesheet_child = 10;else if (l = checkInterpolationJs(i)) tokens[i].stylesheet_child = 11;else throwError(i);
	...
	function getStylesheet() {
	  ...
	  while (pos < tokensLength) {
	    ...
	    if (childType === 9) content.push(getDeclaration());
	    if (childType === 10) content.push(getDeclDelim());
	    if (childType === 11) content.push(getInterpolationJs());
	  }
	...
	function getUriRaw() {
	  ...
	  while (pos < tokens[startPos].uri_raw_end) {
	    if (checkInterpolationJs(pos) || checkInterpolation(pos) || checkVariable(pos)) break;else if (l = checkUriRawCharacters(pos)) pos += l;else break;
	  }
	...
	function checkUri1(i) {
	  ...
	  while (i < tokensLength) {
	    if (l = checkInterpolationJs(i) || checkInterpolation(i) || checkUriRaw(i)) i += l;else break;
	  }
	...
	function getUri1() {
	  ...
	  while (pos < tokens[startPos].uri_end) {
	    if (checkInterpolation(pos)) content.push(getInterpolation());else if (checkInterpolationJs(pos)) content.push(getInterpolationJs());else if (checkUriRaw(pos)) content.push(getUriRaw());else break;
	  }
	...
	function _checkValue(i) {
	  ...
	  if (l = checkInterpolationJs(i)) tokens[i].value_child = 13;else if (l = checkInterpolation(i)) tokens[i].value_child = 1;else if (l = checkVariable(i)) tokens[i].value_child = 2;else if (l = checkVhash(i)) tokens[i].value_child = 3;else if (l = checkBlock(i)) tokens[i].value_child = 4;else if (l = checkAtkeyword(i)) tokens[i].value_child = 5;else if (l = checkOperator(i)) tokens[i].value_child = 6;else if (l = checkImportant(i)) tokens[i].value_child = 7;else if (l = checkGlobal(i)) tokens[i].value_child = 8;else if (l = checkDefault(i)) tokens[i].value_child = 9;else if (l = checkProgid(i)) tokens[i].value_child = 10;else if (l = checkAny(i)) tokens[i].value_child = 11;else if (l = checkParentSelector(i)) tokens[i].value_child = 12;else if (l = checkInterpolationJs(i)) tokens[i].value_child = 13;
	...
	function _getValue() {
	  ...
	  if (childType === 11) return getAny();
	  if (childType === 12) return getParentSelector();
	  if (childType === 13) return getInterpolationJs();
	}
	...
	function checkCompoundSelector2(i) {
	  ...
	  while (i < tokensLength) {
	    var l = checkShash(i) || checkClass(i) || checkAttributeSelector(i) || checkPseudo(i) || checkPlaceholder(i) || checkInterpolation(i) || checkInterpolationJs(i);
	...
	function getCompoundSelector2() {
	  ...
	  while (pos < compoundSelectorEnd) {
	    if (checkShash(pos)) sequence.push(getShash());else if (checkClass(pos)) sequence.push(getClass());else if (checkAttributeSelector(pos)) sequence.push(getAttributeSelector());else if (checkPseudo(pos)) sequence.push(getPseudo());else if (checkPlaceholder(pos)) sequence.push(getPlaceholder());else if (checkInterpolation(pos)) sequence.push(getInterpolation());else if (checkInterpolationJs(pos)) sequence.push(getInterpolationJs());else break;
	  }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Node = __webpack_require__(1);
	var NodeTypes = __webpack_require__(16);
